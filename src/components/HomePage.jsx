      ...
      <header className="future-hero mega-hero" ref={heroRef}>
        ...
        <nav className="future-nav">
          ...
          >
            <Link
              to="/about"
              className="secondary-btn nav-link-btn"
              style={{ border: "none", background: "transparent", color: "var(--home-muted)" }}
            >
              About
            </Link>
            ...
            <Link
              to="/coach"
              className="secondary-btn nav-link-btn"
              style={{ border: "none", background: "transparent", color: "var(--home-accent)" }}
            >
              AI Coach
            </Link>
            ...
            <Link
              to="/tracker"
              className="secondary-btn nav-link-btn nav-tracker-btn"
            >
              Open Tracker
            </Link>
          </motion.div>
